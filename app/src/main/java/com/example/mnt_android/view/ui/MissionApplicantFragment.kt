...
class MissionApplicantFragment : Fragment()
{
    lateinit var binding: FragmentMissionApplicantBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_mission_applicant,container,false)
